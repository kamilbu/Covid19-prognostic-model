...
X, Y = generate_t_series(france_covid, 7)
...
early_stopping = EarlyStopping(monitor='val_loss', mode='min', verbose=1, patience=750)

#training
training = model.fit(X_train, y_train, epochs=1500 , batch_size=5, validation_split=0.2, verbose=2, callbacks=[early_stopping])
