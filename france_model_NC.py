...
X, Y = generate_t_series(france_covid, 30)
...
parameters_X=parameters_X.iloc[30:,:].to_numpy().astype(int)
...
#early_stopping = EarlyStopping(monitor='val_loss', mode='min', verbose=1, patience=1000)


#training
training = model.fit(X_train, y_train, epochs=5000 , batch_size=5, validation_split=0.2, verbose=2)
