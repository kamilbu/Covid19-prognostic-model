...
X, Y = generate_t_series(norway_covid, 30)
...
#training
training = model.fit(X_train, y_train, epochs=1000 , batch_size=5, validation_split=0.2, verbose=2, callbacks=[early_stopping])
